...
def main():
    """
    Головная функция запуска всего приложения.

    Реализует логику простого CRUD-приложени для контактов, но расширенное
    возможностями по изменению некоторых параметров.

    После каждого вызова выполняющего работу с БД реализуется автосохранение.
    """
